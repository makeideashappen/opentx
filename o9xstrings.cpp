...
const pm_char STR_EEPROM_VAR_STD[] PROGMEM = TR_EEPROM_VAR_STD;
const pm_char STR_EEPROM_VAR_V4[] PROGMEM = TR_EEPROM_VAR_V4;
const pm_char STR_EEPROM_VAR_ARM[] PROGMEM = TR_EEPROM_VAR_ARM;
