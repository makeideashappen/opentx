...
#  define INP_J_ROT_ENC_1_PUSH   1    //to verify
#  define INP_J_ROT_ENC_1_B      0    //ko   see .cpp port status
#  define INP_H_ROT_ENC_1_A      1    //ko   see .cpp port status
#  define INP_H_ROT_ENC_2_PUSH   0    //to verify
#  define INP_D_ROT_ENC_2_B      3    //ok, but recognised as rotary 1
#  define INP_D_ROT_ENC_2_A      2    //ok, but recognised as rotary 1
...
/*
#  define INP_E_USB_D_PLS        4    //can be left
#  define INP_E_USB_D_NEG        2    //can be left
#  define OUT_D_HAPTIC           7    //can be left
#  define INP_D_SPARE4           6    //can be left
#  define INP_D_I2C_SCL          1    //can be left
#  define INP_D_I2C_SDA          0    //can be left
*/
