...
extern const pm_char STR_VX_VARIO[];
extern const pm_char STR_VX_SOURCES[];
extern const pm_char STR_VX_LIM[];
extern const pm_char STR_VX_ZERO[];
extern const pm_char STR_VX_AX_MUL[];
extern const pm_char STR_VX_AX_CAL[];
